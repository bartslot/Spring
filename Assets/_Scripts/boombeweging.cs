...
public class boombeweging : MonoBehaviour
{
    ...
    public Transform _boomStronk0, _boomStronk1, _boomHoofd, _boomArm0Left, _boomArm1Left, _boomArm2Left, _boomArm0Right, _boomArm1Right, _boomArm2Right;
    ...
    void Update()
    {
        ...
        UpdateRotationsOfBodyParts();

    }

    private void UpdateRotationsOfBodyParts()
    {
        ...
        foreach (var body in data)
        {
            Kinect.Vector4 orientation = body.JointOrientations[Kinect.JointType.HandLeft].Orientation;
            _boomArm0Left.transform.rotation = new Quaternion(
                orientation.X,
                orientation.Y,
                orientation.Z,
                orientation.W
