...
public class TreeScript : MonoBehaviour {
    ...
    public PrefabJointLinker[] jointPrefabLinker;
    ...
    private GameObject CreateBodyObject(ulong id)
    {
        ...
        for (Kinect.JointType jt = Kinect.JointType.SpineBase; jt <= Kinect.JointType.ThumbRight; jt++)
        {
            ...
            //GameObject jointObj = Instantiate(branchPrefab);//GameObject.CreatePrimitive(PrimitiveType.Cube);
...
[System.Serializable]
public class PrefabJointLinker
{
